# Blue Prince — room & item log

Data store for my **Blue Prince** room & item log. Part of the
[projects hub](../) (`jamessw-ntv.github.io`); this project lives in `blue-prince/`.
...
authentication. **Live viewer: https://jamessw-ntv.github.io/blue-prince/**
...
```
┌──────────────────────────────────────────────────┐
│ jamessw-ntv/jamessw-ntv.github.io · blue-prince/   │
│                                                    │
│   index.html ──fetch raw data.json (cache-bust)─▶ data.json│  on GitHub Pages
│   (read-only viewer)                               │  at https://jamessw-ntv.github.io/blue-prince/
└──────────────────────────────────────────────────┘
```

The viewer fetches `data.json` from the **raw GitHub URL with a cache-buster**
(`https://raw.githubusercontent.com/jamessw-ntv/jamessw-ntv.github.io/main/blue-prince/data.json?_=…`)
...
The hub repo is named `jamessw-ntv.github.io`, so GitHub Pages serves it at the
root automatically from `main`. This project is published at
**https://jamessw-ntv.github.io/blue-prince/** — no per-project Pages setup.
...
- Header controls: a **← Hub** back-link and **💡 Tips** (toggles the `tips[]`
  panel of examples).
